...
const dict = {
    ...
    pageContent: {
        ...
        <br><br>The re-named <a href="https://liquipedia.net/rocketleague/RL_Ireland/Giga-Bite_Cafe_LAN">Giga-byte LAN</a> took place on the 21st of September. Adzer, Ryan and Virtuoso all won their first ever LAN event, defeating LAN regulars Mugg, Fusure and Blah in the final. The fully foreign team of sadGreen, Messy.DD and Thieu.DD came third.<br><br>John_aka_Alwayz and Dave Forehead adminned the event, with Enwrong and Nualaoch casting the day’s action.<br><br>Photos do exist and if you’re reading this then yummy’s bollocked something<br><br>RLI’s 1s league was announced on the 23rd of September, meant to replace the old 6mans.<br><br>Community games night was introduced on the 4th of October. Run by new Moderators Barzey and Luachra, a games night happened roughly every fortnight and it was designed to encourage newer people in the server to get to know everyone better.<br><br>
        Carrickdan started RLI Weekly on the 14th of October, a parody weekly newsletter that commented on the weekly goings-on in the server, primarily focusing on the beef and drama caused by the members.<br><br>RLI’s seasonal 2v2 tournament took place on the 20th of October. Ghost and Jakey beat Shallow and Weetabix in the Tier 1 final, while the Tier 2 final was won by Ryan and Roadman John over AdequateLlama and Poggs.<br><br>On the 27th of October, RLI’s master IEL team, consisting of Jxffa, Walshy, Fusure, and LovelyCans as sub, won in the Grand Finals. Later, the challenger team, consisting of Luachra, Littledude37, Kipp and Ruffs as sub, made it to the Grand finals but sadly couldn’t repeat the same result as the master team.<br><br>
        RLI’s new major league was announced on the 1st of November, called RLI Superstars, or RLIS. The main idea of RLIS was to incorporate 1s, 2s and 3s all into the one league.<br><br><a href="https://liquipedia.net/rocketleague/Insomnia_Dublin">Insomnia Dublin</a> took place on the 9th of November, becoming a record-breaking 4th LAN in the same year for RLI. Mugg, Fusure and Virtuoso took 1st place, with Virtuoso taking MVP as well. Demoqz, JKee and Classy took an arguably surprising 2nd place also. Enwrong adminned the event, and he was assisted by John_aka_Alwayz and LTXSam. Dave Forehead casted the day’s action, joined by Enwrong for the final.<br><br>Darcyyyy stepped down from Admin to Moderator on the 16th of November.<br><br>As part of RLI’s end-of-year announcement on the 31st of December, Luachra was promoted to Operator.<br><br><h2>2020</h2><br><br>
        <br><br>RLI’s second ever independent LAN, set to take place in Ballymena, was announced on the 3rd of January.<br><br>RLI’s winter 3v3 tournament took place on the 25th of January, with a record breaking 0 DQ’s throughout the day. Redeyes, Walshy and Shallow took the win over Demoqz, Arctic and Pandaa. In Tier 2 Ryan, BigBallsBrowne and Ruffs beat AdequateLlama, Spf and Pokewithastick in the final.<br><br>The first season of <a href="https://liquipedia.net/rocketleague/RL_Ireland/RLIS/Season_1">RLIS</a> finished on the 26th of January.<br><br>Squid-G and Ryan were made Moderators on the 16th of February.<br><br>RLI’s Ballymena LAN took place on the 29th of February. NSG (Arctic, Pandaa and Demoqz - shouted at by Enwrong in the final) won 4 - 2, beating Mugg, Fusure and JKee in the final with Arctic taking the MVP award.<br><br>
